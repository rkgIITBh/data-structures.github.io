# Displaying Source Code for Flask API for Queue Operations

<strong>NOTE:</strong> The display flie consists of HTML-Jinja code along with description. To create a template file:
<ul>
        <li>Copy the entire code below to create a file named <samp>app_src.html</samp></li>
</ul>
...
<br>
<div class="container">
<div style="overflow-y: scroll;height: 80%;" class="vertical-scroll addScroll">
