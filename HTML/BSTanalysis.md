...
For the induction hypothesis, assume <p align="center><img src="https://latex.codecogs.com/svg.image?P(i)&space;=&space;4\log&space;i" title="P(i) = 4\log i" /></p> for <img src="https://latex.codecogs.com/svg.image?0\le&space;i&space;<&space;n" title="0\le i < n" />
