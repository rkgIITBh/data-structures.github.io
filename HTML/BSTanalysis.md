...
<ul>Base case</ul>: We know <i>P(1) = 1</i>,  and evaluation of the expression for <i>n=1</i> gives us: 
...
<ul>Induction hypothesis</ul>: Assume 
<p align="center">
  <img src="https://latex.codecogs.com/svg.image?1&space;&plus;&space;4\log&space;i">
  </p>
  for any <i>i</i> less than <i>n</i>. 
 <ul>Proof of induction step</ul>: With the induction hypothesis in mind we apply to terms of the sum in the expression for <i>P(n)</i> and simplify it further
 to obtain: 
<p align="center">
