...
operators. [Click here](../CODES/infixEvalStack/index.md) for the header file. Going through the program, the reader may get a fairly decent idea about implementation with one stack. 
