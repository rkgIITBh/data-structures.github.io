...
The first step requires a time of O(1), and searching linked list containing $$\alpha$$ elements requires an average time of 
$$\alpha/2$$. Therefore, the searching for an element requires time of $$(1+\alpha/2)$$.
