...
5. If <i>N<sub>c</sub></i> is a leaf then use binary search to find presence or absence of <i>k</i> in the current node.
6. Else recursively search for <i>k</i> in <i>N<sub>c</sub></i> 
